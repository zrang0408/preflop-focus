...
//預設各位置手牌範圍
const DEFAULT_UTG_OPEN = rangeFromLists(['AA-77', 'AKs-A2s', 'KQs-K5s', 'QJs-Q9s', 'JTs', 'AKo-ATo', 'KQo-KJo'],[],)
const DEFAULT_HJ_OPEN = rangeFromLists(['AA-66', 'AKs-A2s', 'KQs-K4s', 'QJs-Q8s', 'JTs', 'AKo-A9o', 'A5o', 'KQo-KTo', 'QJo'],[],)
const DEFAULT_CO_OPEN = rangeFromLists(['AA-44', 'AKs-A2s', 'KQs-K2s', 'QJs-Q8s', 'JTs-J8s', 'T9s-T8s', '98s', 'AKo-A7o', 'A5o', 'KQo-KTo', 'QJo-QTo', 'JTo'],[],)
const DEFAULT_BTN_OPEN = rangeFromLists(['AA-33', 'AKs-A2s', 'KQs-K2s', 'QJs-Q4s', 'JTs-J6s', 'T9s-T6s', '98s-96s', '87s-86s', '76s', '65s', 'AKo-A2o', 'KQo-K8o', 'QJo-Q9o', 'JTo-J9o', 'T9o'],[],)
const DEFAULT_SB_OPEN = rangeFromLists(['AA-KK', 'QQ', 'JJ', 'TT', '99-22', 'AKs-A2s', 'KQs-KTs', 'K9s-K2s', 'QJs-Q2s', 'JTs-J4s', 'T9s-T5s', '98s-95s', '87s-85s', '76s-75s', '65s-64s', '54s', 'AKo-A2o', 'KQo-K8o', 'QJo-Q8o', 'JTo-J9o', 'T9o', '98o'],
  [],)
...
const DEFAULT_BB_VS_BTN = rangeFromLists(  ['AA-TT', 'AKs-AQs', 'KQs', 'K3s-K2s', 'Q5s-Q2s', 'J6s-J5s', 'T6s', 'AKo-AQo', 'A5o-A4o', 'KJo-KTo', 'QTo'],
  ['99-22', 'AJs-A2s', 'KJs-K4s', 'QJs-Q6s', 'JTs-J7s', 'T9s-T7s', '98s-96s', '87s-85s', '76s-74s', '65s-64s', '54s-53s', '43s', 'AJo-A7o', 'KQo', 'K9o', 'QJo', 'JTo'],)
